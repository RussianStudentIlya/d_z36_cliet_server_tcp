...
public:
    ...
    void setupUi(QWidget *windowChatForm)
    {
        ...
        QWidget::setTabOrder(messagesLineEdit, senMessagesButton);
        QWidget::setTabOrder(senMessagesButton, closeClientButton);
        QWidget::setTabOrder(closeClientButton, privateChatBrowser);
