...
public:
    ...
    windowChatForm *WindowChatWidget;
    QMenuBar *menubar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        WindowChatWidget = new windowChatForm();
        WindowChatWidget->setObjectName("WindowChatWidget");
        stackedWidget->addWidget(WindowChatWidget);
